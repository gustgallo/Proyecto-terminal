...
export const IntranetLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'Proyectos', path: '/intranet/proyectos', icon: FolderKanban, roles: ['ALL'] },
    { name: 'Solicitudes (Vacaciones)', path: '/intranet/solicitudes', icon: Calendar, roles: ['ALL'] },
    { name: 'Chatbot RRHH (Gemini RAG)', path: '/intranet/chatbot', icon: Bot, roles: ['ALL'] },
    { name: 'Usuarios & Permisos', path: '/intranet/usuarios', icon: Users, roles: ['ADMIN_GLOBAL', 'ADMIN_RRHH'] },
  ];
