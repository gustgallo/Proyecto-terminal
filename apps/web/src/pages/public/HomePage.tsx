  ...
  return (
    <div className="min-h-screen bg-[#0a0e17] flex flex-col selection:bg-cyan-500 selection:text-slate-950">
      ...
      <main className="flex-1">
        ...
        {/* 5. Comparativo de imagen corporativa */}
        <BeforeAfterSection
          subtitle="Transformación de Espacios"
          title="Antes y Después: Renovación de Imagen Corporativa Exterior"
          description="Arrastra el deslizador central para comparar el cambio de visibilidad e impacto visual."
          beforeImage="/assets/marquesina-walmart_ant.webp"
          afterImage="/assets/marquesina-walmart_desp.webp"
          beforeLabel="ANTES"
          afterLabel="DESPUÉS"
        />

        {/* 6.1 Comparativo de iluminación */}
        <BeforeAfterSection
          subtitle="Soluciones Luminosas"
          title="Antes y Después: Mantenimiento de Elementos Luminosos"
          description="Compara el espacio antes y después de incorporar una solución de iluminación desarrollada por Prodisa."
          beforeImage="/assets/unipolar_antes .webp"
          afterImage="/assets/unipolar_despues .webp"
          beforeLabel="ANTES"
          afterLabel="DESPUÉS"
        />
