...
- No se incluyen las credenciales reales heredadas de la arquitectura Node anterior.

## Validación que debe hacerse en GoogieHost

La conexión real a MariaDB no puede comprobarse fuera del hosting porque el plan gratuito bloquea TCP/3306. Después de completar `config.local.php` y publicar, verifica:
